...
if path.isfile(path.expanduser('~/.is_chase_ci')):
    ...
    if hostname == 'daeyun-01':
        ...
        scene3d_root = '/home/daeyuns/data/scene3d'
    ...
    default_out_root = '/data4/out/scene3d'
    default_out_root_v8 = '/data3/out/scene3d'
    etn_features_root = '/data3/out/scene3d/overhead_pred'
    nyu_root = '/data3/nyu'
    ...
    etn_features_root = '/mnt/scratch0/daeyuns/data/overhead_pred_shard_links'
    etn_features_root2 = path.expanduser('~/out/scene3d/overhead_pred_shards/')
    etn_zb_features_root = '/mnt/scratch0/daeyuns/data/overhead_zb_pred_shard_links'
    etn_zb_features_root2 = path.expanduser('~/scene3d/overhead_zb_pred_shards/')
    overhead_pred_out_root = '/mnt/scratch2/daeyuns/data/out/scene3d'
