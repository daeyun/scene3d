...
def validation():
    ...
    dataset = v8.MultiLayerDepth(
        ...
        subtract_mean=True, image_hw=(240, 320), first_n=None, rgb_scale=1.0 / 255, fields=('rgb', 'overhead_camera_pose_4params'))
    ...
    filenames = sorted(glob.glob('/data3/out/scene3d/v8/v8-overhead_camera_pose_4params/0/*.pth'))
    ...
    out_file = '/data3/out/scene3d/overhead_param4_pred/01_validation.pkl'
...
def training():
    ...
    out_file = '/data3/out/scene3d/overhead_param4_pred/01_train.pkl'
    io_utils.ensure_dir_exists(path.dirname(out_file))
    with open(out_file, 'wb') as f:
        pickle.dump(output_all, f)
