...
const std::set<std::string> suncg_plants_and_people
    {"130", "237", "323", "324", "325", "333", "346", "463", "620", "623", "624", "634", "637", "717", "718", "719", "720", "721", "723", "724", "725", "726", "727", "728", "731", "732",
     "733", "734", "735", "736", "737", "738", "739", "740", "741", "742", "786", "s__1335", "s__1541", "s__1543", "s__1779", "s__1780", "s__1781", "s__1782", "s__1783", "s__1784", "s__1785",
     "s__1786", "s__1787", "s__1788", "s__1957", "s__1958", "s__1959", "s__1960", "s__1961", "s__1962"};
...
bool ReadFacesAndVertices(const std::string &filename,
  ...
  for (int node_index = 0; node_index < nodes.size(); ++node_index) {
    ...
    for (int i = 0; i < node->mNumMeshes; ++i) {
      ...
      // TODO(daeyun): This is specific to the OBJ meshes generated by SUNCG. Needs refactoring.
      if (meshname.find("Model#") != std::string::npos) {
        string model_id = meshname.substr(meshname.find('#') + 1);
        if (suncg_plants_and_people.find(model_id) != suncg_plants_and_people.end()) {
          // If the model id matches a plant or person, skip.
          continue;
        }
      }
